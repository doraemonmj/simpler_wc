...
# output_prefix + 64-byte NUL-terminated scope_stats_scope + scope_stats_task
# int32. Log config travels separately via ChipWorker.init(log_level,
# log_info_v) — not on per-task wire.
_CFG_FMT = struct.Struct("=iiiiiii1024s64si")
...
def _read_config_from_mailbox(buf: memoryview) -> "CallConfig":
    ...
    # NUL-terminated C string in a 64-byte field (comma-separated scope lines).
